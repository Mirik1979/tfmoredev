...
?><?$APPLICATION->IncludeComponent("bitrix:socialnetwork_group", "", array(
	...
	"NAME_TEMPLATE" => "",
	"PATH_TO_USER" => "/private_cloud/contacts/personal/user/#user_id#/",
	"PATH_TO_USER_LOG" => "/private_cloud/contacts/personal/log/",
	"PATH_TO_SUBSCRIBE" => "/private_cloud/contacts/personal/subscribe/",
	"PATH_TO_GROUP_CREATE" =>"/private_cloud/contacts/personal/user/#user_id#/groups/create/",
	"PATH_TO_SEARCH_EXTERNAL" => "/private_cloud/contacts/index.php",
	"PATH_TO_MESSAGES_CHAT" => "/private_cloud/contacts/personal/messages/chat/#user_id#/",
	"PATH_TO_USER_CALENDAR" => "/private_cloud/contacts/personal/user/#user_id#/calendar/",
	"PATH_TO_MESSAGE_FORM_MESS" => "/private_cloud/contacts/personal/messages/form/#user_id#/#message_id#/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_VIDEO_CALL" => "/private_cloud/contacts/personal/video/#USER_ID#/",
	"PATH_TO_BIZPROC_TASK" => "/private_cloud/contacts/personal/user/#user_id#/bizproc/#id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/private_cloud/contacts/personal/user/#user_id#/bizproc/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/private_cloud/workgroups/",
	"AJAX_MODE" => "N",
