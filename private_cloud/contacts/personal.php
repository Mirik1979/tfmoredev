...
?> <?$APPLICATION->IncludeComponent("bitrix:socialnetwork_user", ".default", array(
	...
	"NAME_TEMPLATE" => "",
	"PATH_TO_GROUP" => "/private_cloud/workgroups/group/#group_id#/",
	"PATH_TO_GROUP_SUBSCRIBE" => "/private_cloud/workgroups/group/#group_id#/subscribe/",
	"PATH_TO_GROUP_SEARCH" => "/private_cloud/workgroups/group/search/",
	"PATH_TO_SEARCH_EXTERNAL" => "/private_cloud/contacts/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_GROUP_TASKS" => "/private_cloud/workgroups/group/#group_id#/tasks/",
	"PATH_TO_GROUP_TASKS_TASK" => "/private_cloud/workgroups/group/#group_id#/tasks/task/#action#/#task_id#/",
	"PATH_TO_GROUP_TASKS_VIEW" => "/private_cloud/workgroups/group/#group_id#/tasks/view/#action#/#view_id#/",
	"PATH_TO_GROUP_POST" => "/private_cloud/workgroups/group/#group_id#/blog/#post_id#/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_VIDEO_CALL" => "/private_cloud/contacts/personal/video/#USER_ID#/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/private_cloud/contacts/personal/",
	"AJAX_MODE" => "N",
...
//		"group_create" => "/private_cloud/workgroups/create/",
